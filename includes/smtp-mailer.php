...
class SmtpMailer {
    ...
    public function sendMail($fromEmail, $fromName, $to, $subject, $body, $replyTo = '') {
...
function sendAppEmail($db, $to, $subject, $body, $replyTo = '', &$errorOut = null) {
    ...
    $ok = $mailer->sendMail($fromEmail, $fromName, $to, $subject, $body, $replyTo);
