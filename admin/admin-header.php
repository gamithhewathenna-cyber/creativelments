<?php
// Most pages already require admin-auth.php themselves (before doing any redirect-issuing
// delete/toggle/save logic). Load it here too in case a page requires this file directly.
if (empty($adminAuthLoaded)) require_once 'admin-auth.php';
...
<aside class="sidebar">
  <div class="sidebar-logo">
    <?php if (!empty($siteLogo)): ?>
      <img src="<?= SITE_URL ?>/uploads/branding/<?= htmlspecialchars($siteLogo) ?>" alt="Logo" style="width:170px;height:35px;object-fit:contain">
    <?php else: ?>
      <div class="lm">CE</div>
  ...
  <nav class="sidebar-nav">
    ...
    <a href="/admin/team.php" class="<?= $currentPage==='team'?'active':'' ?>">
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
      Team
    </a>
    <a href="/admin/locations.php" class="<?= $currentPage==='locations'?'active':'' ?>">
    ...
    <a href="/admin/about-page.php" class="<?= $currentPage==='about-page'?'active':'' ?>">
    ...
    <a href="/admin/seo.php" class="<?= $currentPage==='seo'?'active':'' ?>">
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
      SEO
    </a>
    <a href="/admin/chatbot-faqs.php" class="<?= $currentPage==='chatbot-faqs'?'active':'' ?>">
